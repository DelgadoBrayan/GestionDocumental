...
export const ActualizarInforme = () => {
 ...
 const [alert, setAlert] = useState({})
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`http://localhost:3000/informes/actualizarInforme/${id}`, formData, {
        headers: {
  ...
  return (
    ...
    <form action="" className="ml-96 " onSubmit={handleSubmit}>
      <Alert alert={alert}/>
    <h1 className="font-medium text-xl pt-10 mb-5 ml-3">Actualizar Informe</h1>
