...
export const ActualizarInformeE = () => {
  ...
  const {id} = useParams()
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await axios.post(`http://localhost:3000/reportes/actualizarReporte/${id}`, formData, {
          headers: {
    ...
    return (
      ...
      <Alert alert={alert}/>
      <h1 className="font-medium text-xl mt-10 mb-5 ml-3">Actualizar  Reporte</h1>
