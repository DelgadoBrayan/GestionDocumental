 ...
 const [alert, setAlert] = useState({})
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`http://localhost:3000/manuales/actualizarManual/${id}`, formData, {
        headers: {
  ...
  return (
    ...
    <Alert alert={alert}/>
    <h1 className="font-medium text-xl mt-10 mb-5 ml-3">Actualizar Manual</h1>
